...
<body>
    ...
    <header >
      <div class="container-fluid row" id="header" >
        ...
        <div id="nav_large" class="col-md-9 col-sm-9 col-xs-9" >
          <ul class="nav" id="nav-link-bs"  >
            ...
            <li class="nav-item" >
              <a href="./contactus.php" target="blank" class="nav-link active_link" >Contact us</a>
            </li>
      ...
      <div class="collapse" id="nav_mobile">
        ...
        <div >
          <a href="./contactus.php" target="blank" class="nav-link nav_link_rad_start active_link_m" >
    ...
    <div class="container" id="contactus">
        ...
        <p >
          <a href="mailto:220072233@student.uj.ac.za">
            <i class="fa fa-paper-plane" ></i> Email
          </a> [ 220072233@student.uj.ac.za ]
        </p>
